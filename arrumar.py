        ...
        case 2 | 3 | 4 | 5:  #verificar se somente numeros
            if not doces:
                ...
                if op == 2:
                    ...
                    deletar_produto()
        case 6:
            confirmar = input("Tem certeza que deseja sair? (s/n): ").lower()#Tá uma merda, arruma
            if confirmar == "s":#está aceitando qualquer letra
                print("Saindo do sistema... Até logo!")#crie uma verificação para ser somente s ou n caso contrário return
        case _:
